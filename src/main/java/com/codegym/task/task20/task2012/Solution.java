...
Requirements:
•	The Solution.OutputToConsole class should support the Externalizable interface.
•	The OutputToConsole class must be inside the Solution class.
•	The OutputToConsole class must be public.
•	The OutputToConsole class must be static.
